...
##Just binding the tools 
#result = llm_with_tool.invoke("Hello")
#result2 = llm.invoke("Hello")

##Now calling the tools
#result = llm_with_tool.invoke("Returns the number of character in a given text:'how are you'")
#result2 = llm.invoke("Returns the number of character in a given text:'how are you'")
